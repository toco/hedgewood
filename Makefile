...
Hedgewood: main.o SDLfunctions.o menu.o graphicUpdate.o pathfinding.o
	$(CC) $(SDLFLAGS) $(CFLAGS) -o Hedgewood main.o SDLfunctions.o menu.o graphicUpdate.o pathfinding.o
